...
export default [
  ...
  <p style="font-size:16px;color:#92400e;margin-bottom:28px;opacity:0.8;">每週一封精選內容，不發廣告，只給您真正有用的資訊。</p>
  <div style="display:flex;gap:0;max-width:440px;margin:0 auto;box-shadow:0 4px 20px rgba(0,0,0,0.1);">
    <input type="email" placeholder="輸入您的 Email" style="flex:1;padding:14px 20px;border:none;border-radius:10px 0 0 10px;font-size:16px;background:#fff;outline:none;">
    <button style="background:#d97706;color:#fff;border:none;padding:14px 24px;border-radius:0 10px 10px 0;font-size:16px;font-weight:700;cursor:pointer;white-space:nowrap;">訂閱</button>
  </div>
  <p style="font-size:16px;color:#a16207;margin-top:14px;opacity:0.7;">已有 8,200+ 人訂閱 · 可隨時取消</p>
</section>`,
  },
  {
    id: 'cta0003',
  ...
  <button style="background:#fff;color:${T.indigo500};border:none;padding:15px 40px;border-radius:10px;font-size:16px;font-weight:800;cursor:pointer;box-shadow:0 8px 30px rgba(0,0,0,0.2);">預約免費諮詢</button>
</section>`,
  },
];
