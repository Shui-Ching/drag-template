...
export default [
  ...
  <div style="flex:1;display:flex;flex-direction:column;justify-content:center;padding:64px 56px;">
    ...
    <div style="display:flex;gap:12px;">
      <button style="background:${T.slate900};color:#fff;border:none;padding:14px 32px;border-radius:8px;font-size:16px;font-weight:600;cursor:pointer;">立即開始</button>
      <button style="background:transparent;color:${T.slate900};border:2px solid ${T.slate200};padding:14px 32px;border-radius:8px;font-size:16px;font-weight:600;cursor:pointer;">了解更多 →</button>
    </div>
  </div>
  ...
  <div style="display:inline-flex;align-items:center;gap:8px;background:rgba(99,102,241,0.1);border:1px solid rgba(99,102,241,0.3);border-radius:999px;padding:6px 16px;margin-bottom:28px;">
    ...
    <span style="font-size:16px;color:#a5b4fc;font-weight:500;">全新功能上線</span>
  </div>
  ...
  <div style="display:flex;gap:14px;">
    <button style="background:${T.gradIndigo};color:#fff;border:none;padding:14px 36px;border-radius:10px;font-size:16px;font-weight:700;cursor:pointer;box-shadow:0 0 30px rgba(99,102,241,0.4);">免費體驗 14 天</button>
    <button style="background:rgba(255,255,255,0.05);color:#a1a1aa;border:1px solid rgba(255,255,255,0.1);padding:14px 28px;border-radius:10px;font-size:16px;cursor:pointer;">觀看 Demo →</button>
  </div>
</section>`,
  },
  {
    ...
    label: 'Clean Minimal',
    thumbType: 'banner',
    html: `<section style="background:#fafafa;min-height:400px;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:80px 48px;border-bottom:1px solid #e5e7eb;">
  <p style="font-size:16px;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:#9ca3af;margin-bottom:24px;">SINCE 2019</p>
  ...
  <a href="#" style="display:inline-flex;align-items:center;gap:8px;font-size:16px;font-weight:700;color:#111827;text-decoration:none;border-bottom:2px solid #111827;padding-bottom:2px;">探索我們的故事 →</a>
</section>`,
  },
  {
    id: 'banner0004',
    label: 'Image Overlay',
    thumbType: 'banner',
    html: `<section style="position:relative;min-height:460px;display:flex;align-items:center;overflow:hidden;background:linear-gradient(120deg,#0369a1 0%,#075985 40%,#0c4a6e 100%);">
  ...
  <div style="position:relative;padding:64px 64px;max-width:660px;">
    <div style="font-size:16px;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;color:#7dd3fc;margin-bottom:20px;">企業解決方案</div>
    ...
    <button style="background:#fff;color:#0369a1;border:none;padding:14px 32px;border-radius:8px;font-size:16px;font-weight:700;cursor:pointer;">聯絡業務顧問</button>
  </div>
</section>`,
  },
];
