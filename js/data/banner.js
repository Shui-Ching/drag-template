...
export default [
  ...
  <div style="display:inline-flex;align-items:center;gap:8px;background:rgba(99,102,241,0.1);border:1px solid rgba(99,102,241,0.3);border-radius:999px;padding:6px 16px;margin-bottom:28px;">
    ...
    <span style="font-size:16px;color:#fff;font-weight:500;">全新功能上線</span>
  </div>
  <h1 style="font-size:56px;font-weight:900;color:#fff;line-height:1.1;letter-spacing:-2px;margin-bottom:20px;max-width:700px;">打造<span style="background:linear-gradient(135deg,${T.indigo400},${T.sky500});-webkit-background-clip:text;-webkit-text-fill-color:transparent;">未來感</span>的數位體驗</h1>
  ...
  <div style="max-width:1200px;margin:0 auto;padding:0 48px;width:100%;display:flex;flex-direction:column;align-items:center;text-align:center;">
    ...
    <p style="font-size:16px;color:${T.slate500};line-height:1.8;max-width:480px;margin-bottom:40px;">我們相信優秀的產品應該不需要說明書。每一個細節都經過精心設計，讓使用者自然地找到答案。</p>
    <a href="#" style="display:inline-flex;align-items:center;gap:8px;font-size:16px;font-weight:700;color:${T.slate900};text-decoration:none;border-bottom:2px solid ${T.slate900};padding-bottom:2px;">探索我們的故事 →</a>
  </div>
</section>`,
  },
  {
  ...
  <div style="position:relative;max-width:1200px;margin:0 auto;padding:0 48px;">
    <div style="max-width:600px;">
      ...
      <button style="background:#fff;color:${T.indigo500};border:none;padding:14px 32px;border-radius:8px;font-size:16px;font-weight:700;cursor:pointer;">聯絡業務顧問</button>
    </div>
  </div>
</section>`,
  },
